...
Think about those messy commits, without any pattern nor any body description, that you have certainly encountered at some point of your career. To give you a better example over what I'm talking about, [take a look at some of the initial commits from my blog](https://github.com/dotpegaso/personal-blog/commits/master) (until March 29th, 2021).

I made those commits that way on purpose, to illustrate this whole discussion about __how well-made commit messages matter__, and how it can improve the project that you are working along with your team.
...
If your current team doesn't care about all that jazz, bring that up for them! It's something that can be good for everybody.
